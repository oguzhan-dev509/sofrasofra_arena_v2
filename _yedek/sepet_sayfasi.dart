...
class _SepetSayfasiState extends State<SepetSayfasi> {
      ...
      child: Column(
        ...
        children: [
          ...
          _paymentOptionTile(
            value: 'cash',
            title: 'Kapıda Nakit',
            subtitle: 'Teslimatta nakit ödeme',
          ...
          _paymentOptionTile(
            ...
            subtitle: 'Kurye yanında POS cihazı ile ödeme',
  ...
  Widget _paymentOptionTile({
    ...
    final bool selected = _selectedPayment == value;
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? const Color(0x22FFC107) : _chipBg,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
            color: selected
                ? _gold
        ...
        child: Row(
          children: [
            Icon(
              icon,
              color: enabled ? (selected ? _gold : _textMuted) : Colors.white30,
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    subtitle,
                    style: TextStyle(
                      color: enabled ? _textMuted : Colors.white24,
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
