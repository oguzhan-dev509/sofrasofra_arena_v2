...
class SpecialEventsArchivePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        elevation: 0,
        title: const Text("ÖZEL DAVET ARŞİVİ",
            style: TextStyle(
        ...
        actions: [
          IconButton(
              icon:
                  const Icon(Icons.search, color: Color(0xFFFFB300), size: 20),
              onPressed: () {}),
          IconButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionTitle("VİDEO KAYITLARI", Icons.edit_note),
  ...
  Widget _buildHeaderInfo() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text("UNUTULMAZ ANLARIN MİMARİSİ",
            style: TextStyle(
                color: Colors.white,
                fontSize: 16,
        ...
        const Text("Her davet bir hikaye, her menü bir hatıradır.",
            style: TextStyle(
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(time,
                    style:
                        const TextStyle(color: Color(0xFFFFB300), fontSize: 9)),
              )
            ],
          ),
