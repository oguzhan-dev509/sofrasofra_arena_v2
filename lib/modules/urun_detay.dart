...
import 'package:sofrasofra_arena_v2/modules/widgets/ev_gallery_three_column_grid.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Ev gallery grid: show all photos, fixed 3 photos per row.
          EvGalleryThreeColumnGrid(
            images: images,
