class SofrasofraHukukiMetin {
  final String title;
  final String slug;
  final String summary;
  final String content;

  const SofrasofraHukukiMetin({
    required this.title,
    required this.slug,
...
const List<SofrasofraHukukiMetin> sofrasofraHukukiMetinler = [
  SofrasofraHukukiMetin(
    title: 'Gizlilik Politikası',
    slug: 'gizlilik-politikasi',
    summary:
        'Sofrasofra kullanıcılarının kişisel verilerinin nasıl işlendiğini açıklar.',
    content: '''
Gizlilik Politikası
...
İşbu Gizlilik Politikası, UYBAT TEKNOLOJİ YAZILIM VE TİCARET LİMİTED ŞİRKETİ tarafından işletilen Sofrasofra platformu, www.sofrasofra.com internet sitesi, mobil uygulamalar, dijital hizmetler, başvuru formları, destek kanalları ve bağlantılı hizmetler üzerinden elde edilen bilgilerin hangi amaçlarla toplandığını, kullanıldığını, saklandığını, paylaşıldığını ve korunduğunu açıklamak amacıyla hazırlanmıştır.

Sofrasofra; Ev Lezzetleri üreticilerini, Usta Şefleri, restoranları, kuryeleri, müşterileri, iş ortaklarını ve destek ekiplerini dijital ortamda bir araya getiren teknoloji tabanlı bir gastronomi ve yerel üretim platformudur.

Bu Politika, Sofrasofra’yı ziyaret eden, üye olan, başvuru yapan, sipariş veren, ürün veya hizmet sunan, kurye olarak başvuran, destek kanalları üzerinden iletişime geçen veya platform hizmetlerinden herhangi bir şekilde yararlanan tüm gerçek kişilere yönelik genel bilgilendirme niteliğindedir.
...
Sofrasofra hizmetlerinin niteliğine göre aşağıdaki veri kategorileri işlenebilir:

Kimlik ve iletişim bilgileri:
Ad, soyad, telefon numarası, e-posta adresi, şehir, ilçe, adres, başvuru ve iletişim bilgileri.

Üyelik ve hesap bilgileri:
Kullanıcı ID bilgisi, hesap türü, başvuru durumu, platform içi rol, üretici/şef/restoran/kurye profili, üyelik ve kullanım bilgileri.

Sipariş ve işlem bilgileri:
Sipariş içeriği, ürün veya hizmet bilgisi, teslimat tercihi, sepet bilgisi, ödeme durumu, sipariş geçmişi, iptal/iade kayıtları ve işlem zamanları.

Üretici, şef, restoran ve kurye başvuru bilgileri:
Başvuru formunda sunulan işletme, çalışma durumu, vergi veya kimlik bilgisi, IBAN, fatura bilgisi, açıklama, deneyim, faaliyet türü, destekleyici notlar ve başvuru değerlendirme bilgileri.

Fatura ve finansal süreç bilgileri:
T.C. kimlik numarası veya vergi numarası, vergi dairesi, fatura adresi, fatura e-posta adresi, IBAN, hak ediş, komisyon, platform hizmet bedeli, ödeme ve mahsuplaşma kayıtları.

Konum ve teslimat bilgileri:
Teslimat adresi, şehir/ilçe bilgisi, kurye teslimat sürecinde gerekli konum ve operasyon bilgileri.

Görsel, video ve içerik bilgileri:
Ürün, galeri, profil, kapak, akademi, imza tabağı, restoran, üretici, şef veya platform tanıtımı kapsamında yüklenen fotoğraf, video, açıklama ve metin içerikleri.

Teknik veriler:
IP adresi, cihaz bilgisi, tarayıcı bilgisi, oturum kayıtları, hata kayıtları, güvenlik logları, çerezler, uygulama kullanım verileri ve benzeri teknik bilgiler.

Destek ve iletişim kayıtları:
E-posta, WhatsApp, telefon, destek formu veya diğer iletişim kanalları üzerinden iletilen mesajlar, talepler, şikâyetler ve işlem notları.
...
- Ev Lezzetleri, Usta Şef, restoran ve kurye başvurularının alınması ve değerlendirilmesi,
- Sipariş, ödeme, teslimat, iptal, iade ve destek süreçlerinin yürütülmesi,
- Üretici, şef, restoran ve kurye profillerinin oluşturulması,
- Ürün, hizmet, galeri ve vitrin içeriklerinin yayınlanması,
- Fatura, hak ediş, komisyon, ödeme ve muhasebe süreçlerinin yürütülmesi,
- Müşteri memnuniyeti, destek ve şikâyet süreçlerinin yönetilmesi,
- Platform güvenliğinin sağlanması ve kötüye kullanımın önlenmesi,
- Yasal yükümlülüklerin yerine getirilmesi,
- Operasyonel raporlama, iç denetim, başvuru inceleme ve kalite kontrol faaliyetlerinin yürütülmesi,
- Kullanıcı deneyiminin iyileştirilmesi,
- Açık rıza veya mevzuata uygun diğer hukuki sebeplerin bulunması halinde kampanya, duyuru ve bilgilendirme faaliyetlerinin yürütülmesi.

5. Kişisel Verilerin Toplanma Yöntemleri

Kişisel veriler; internet sitesi, mobil uygulama, başvuru formları, üyelik formları, sipariş ekranları, ödeme ve teslimat süreçleri, destek e-postaları, WhatsApp ve telefon iletişim hatları, Firebase/Google altyapıları, ödeme hizmet sağlayıcıları, çerezler, log kayıtları ve kullanıcı tarafından platforma yüklenen içerikler aracılığıyla elektronik ortamda toplanabilir.

6. Kişisel Verilerin Paylaşılması

Kişisel veriler, hizmetin gerektirdiği ölçüde ve mevzuata uygun olarak aşağıdaki taraflarla paylaşılabilir:

- Ödeme hizmet sağlayıcıları,
- Kargo, teslimat veya kurye süreçlerinde görev alan kişiler,
- Bulut altyapısı, barındırma, veri tabanı, bildirim, analiz ve güvenlik hizmet sağlayıcıları,
- Muhasebe, finans, fatura, e-arşiv/e-fatura veya benzeri hizmet sağlayıcıları,
- Hukuki danışmanlar, mali müşavirler ve denetçiler,
- Yetkili kamu kurum ve kuruluşları,
- Siparişin ifası için gerekli olduğu ölçüde satıcı, üretici, şef, restoran, müşteri veya kurye tarafları.

Sofrasofra, kişisel verileri ticari amaçla üçüncü kişilere satmaz.

7. Ödeme Bilgileri

Sofrasofra üzerinden yapılan ödemelerde kart bilgileri Sofrasofra tarafından saklanmaz. Ödeme işlemleri, ilgili ödeme hizmet sağlayıcısının güvenli altyapısı üzerinden gerçekleştirilir. Sofrasofra ödeme sonucuna, işlem durumuna ve siparişle ilişkili finansal kayıtlara erişebilir; ancak kart numarası, CVV gibi hassas kart bilgilerini kendi sistemlerinde saklamaz.

8. Çerezler ve Benzeri Teknolojiler

Sofrasofra web sitesi ve dijital hizmetlerinde çerezler ve benzeri teknolojiler kullanılabilir. Bu teknolojiler; oturum yönetimi, güvenlik, performans, kullanıcı deneyimi, tercihlerin hatırlanması ve hizmetlerin iyileştirilmesi amacıyla kullanılabilir. Çerezlere ilişkin ayrıntılı açıklamalar ayrıca Çerez Politikası içinde düzenlenir.

9. Veri Güvenliği

Sofrasofra, kişisel verilerin yetkisiz erişime, kayba, kötüye kullanıma, izinsiz değiştirmeye veya ifşaya karşı korunması için makul teknik ve idari tedbirleri alır. Bu kapsamda erişim yetkilendirmeleri, güvenlik kuralları, bulut altyapısı güvenlik önlemleri, kayıt denetimleri ve yetki sınırlamaları uygulanır.

Bununla birlikte internet üzerinden yapılan hiçbir veri aktarımının mutlak güvenlik garantisi veremeyeceği kullanıcı tarafından bilinmelidir.

10. Saklama Süreleri

Kişisel veriler, işleme amacının gerektirdiği süre boyunca ve ilgili mevzuatta öngörülen zamanaşımı, muhasebe, vergi, tüketici, ticaret, sözleşme ve uyuşmazlık süreleri dikkate alınarak saklanır.
...
Kişisel verisi işlenen kişiler, 6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında aşağıdaki haklara sahiptir:
...
- Mevzuata uygun olarak silinmesini veya yok edilmesini isteme,
- Aktarıldığı üçüncü kişilere bildirilmesini isteme,
- Otomatik sistemler yoluyla aleyhe sonuç çıkmasına itiraz etme,
- Kanuna aykırı işleme nedeniyle zarara uğranması halinde zararının giderilmesini talep etme.

Bu haklara ilişkin başvurular info@sofrasofra.com adresine iletilebilir.

12. Üçüncü Taraf Bağlantılar

Sofrasofra içinde üçüncü taraf internet sitelerine, ödeme sayfalarına, harita servislerine, video platformlarına veya sosyal medya hesaplarına bağlantılar bulunabilir. Bu üçüncü taraf hizmetlerin kendi gizlilik politikaları geçerlidir. Sofrasofra, üçüncü taraf platformların veri işleme uygulamalarından sorumlu değildir.

13. Politika Değişiklikleri

Sofrasofra, bu Gizlilik Politikası’nı mevzuat, hizmet modeli, teknik altyapı veya operasyonel ihtiyaçlar doğrultusunda güncelleyebilir. Güncel politika www.sofrasofra.com ve ilgili dijital kanallar üzerinden yayınlandığı anda geçerlilik kazanır.

14. İletişim

Gizlilik Politikası ve kişisel verilerin korunmasına ilişkin sorularınız için aşağıdaki iletişim kanalları kullanılabilir:
...
''',
  ...
  SofrasofraHukukiMetin(
    ...
    summary:
        '6698 sayılı KVKK kapsamında kişisel verilerin işlenmesine ilişkin bilgilendirme.',
    content: '''
...
''',
  ...
  SofrasofraHukukiMetin(
    ...
    summary:
        'Sofrasofra web sitesi ve dijital hizmetlerinde kullanılan çerezlere ilişkin bilgilendirme.',
    content: '''
Çerez Politikası
...
''',
  ...
  SofrasofraHukukiMetin(
    ...
    summary: 'Sofrasofra platformunun kullanımına ilişkin genel kurallar.',
    content: '''
Kullanım Koşulları
...
İşbu Kullanım Koşulları, UYBAT TEKNOLOJİ YAZILIM VE TİCARET LİMİTED ŞİRKETİ tarafından işletilen Sofrasofra platformunun, www.sofrasofra.com internet sitesinin, mobil uygulamalarının, web uygulamasının, dijital hizmetlerinin, başvuru formlarının, destek kanallarının ve bağlantılı tüm hizmet alanlarının kullanımına ilişkin genel kuralları düzenler.

Sofrasofra; Ev Lezzetleri üreticilerini, Usta Şefleri, restoranları, kuryeleri, müşterileri, iş ortaklarını ve destek ekiplerini dijital ortamda bir araya getiren teknoloji tabanlı bir gastronomi, yerel üretim, satış, tanıtım, başvuru ve operasyon platformudur.

Platformu ziyaret eden, kullanan, üye olan, sipariş veren, başvuru yapan, ürün veya hizmet sunan, kurye olarak görev alan, destek kanalları üzerinden iletişim kuran veya Sofrasofra hizmetlerinden herhangi bir şekilde yararlanan herkes işbu Kullanım Koşulları’nı kabul etmiş sayılır.

2. Tanımlar

Sofrasofra / Platform:
UYBAT TEKNOLOJİ YAZILIM VE TİCARET LİMİTED ŞİRKETİ tarafından işletilen www.sofrasofra.com, mobil uygulamalar, web uygulaması ve bağlantılı dijital hizmetleri ifade eder.

Şirket:
UYBAT TEKNOLOJİ YAZILIM VE TİCARET LİMİTED ŞİRKETİ’ni ifade eder.

Kullanıcı:
Platformu ziyaret eden, üye olan, sipariş veren, başvuru yapan, içerik görüntüleyen veya herhangi bir şekilde platformdan yararlanan gerçek veya tüzel kişiyi ifade eder.

Müşteri:
Platform üzerinden ürün veya hizmet inceleyen, sepete ekleyen, sipariş veren veya satın alma işlemi yapan kullanıcıyı ifade eder.

Üretici:
Ev Lezzetleri alanında ürün, içerik veya hizmet sunmak üzere başvuru yapan veya platformda yer alan kişiyi ifade eder.

Usta Şef:
Platformda şef profili, imza tabağı, eğitim, danışmanlık, davet, catering veya benzeri hizmetlerle yer alan kişiyi ifade eder.

Restoran:
Platformda ürün, menü, hizmet veya tanıtım sunan restoran, işletme veya işletme temsilcisini ifade eder.

Kurye:
Platform üzerinden teslimat süreçlerine dahil olan, başvuru yapan veya görev alan kişiyi ifade eder.

İçerik:
Kullanıcılar, üreticiler, şefler, restoranlar, kuryeler veya iş ortakları tarafından platforma yüklenen fotoğraf, video, açıklama, ürün bilgisi, fiyat, galeri, eğitim, yorum, başvuru bilgisi ve benzeri her türlü veriyi ifade eder.

3. Platformun Rolü

Sofrasofra, teknoloji tabanlı bir dijital platform olarak kullanıcılar, üreticiler, şefler, restoranlar, kuryeler ve iş ortakları arasında dijital görünürlük, başvuru, tanıtım, sipariş, ödeme yönlendirme, sepet, teslimat organizasyonu, destek ve operasyon süreçlerinin yürütülmesine aracılık eden bir altyapı sağlar.

Sofrasofra, uygun görülen hallerde platform hizmet bedeli, komisyon, üyelik, reklam, görünürlük, teknik hizmet, operasyon veya benzeri hizmet gelirleri elde edebilir.

Sofrasofra’nın platform üzerindeki rolü, her somut işlemde ürünün veya hizmetin doğrudan satıcısı olduğu anlamına gelmez. Ürün veya hizmeti fiilen sunan üretici, şef, restoran, kurye veya ilgili hizmet sağlayıcı, kendi faaliyetinden, sunduğu bilgilerin doğruluğundan, ürün/hizmet kalitesinden, hijyeninden, mevzuata uygunluğundan ve yasal yükümlülüklerinden sorumludur.

Sofrasofra, platform güvenliği, kullanıcı deneyimi, ödeme ve operasyon süreçlerinin düzenlenmesi, başvuru incelemesi, görünürlük yönetimi, içerik denetimi ve destek süreçleri bakımından makul özeni gösterir.

4. Kullanıcı Hesabı ve Üyelik

Kullanıcılar, platformun bazı özelliklerinden yararlanmak için hesap oluşturmak, başvuru yapmak veya gerekli bilgileri paylaşmak zorunda olabilir.

Kullanıcı, platforma sunduğu bilgilerin doğru, güncel, eksiksiz ve hukuka uygun olduğunu kabul eder. Yanlış, eksik, yanıltıcı veya başkasına ait bilgilerle işlem yapılması halinde doğabilecek zararlardan ilgili kullanıcı sorumludur.

Kullanıcı, hesabının güvenliğinden, erişim bilgilerinin korunmasından ve hesabı üzerinden yapılan işlemlerden sorumludur. Hesabın yetkisiz kullanıldığının fark edilmesi halinde Sofrasofra’ya gecikmeksizin bilgi verilmelidir.

Sofrasofra, güvenlik, kötüye kullanım, hukuka aykırılık, yanıltıcı başvuru, sahte hesap, sistem bütünlüğünün korunması veya kullanıcı güvenliği gibi sebeplerle hesapları inceleyebilir, geçici olarak kısıtlayabilir, askıya alabilir veya kapatabilir.

5. Başvuru Süreçleri

Ev Lezzetleri üreticileri, Usta Şefler, restoranlar, kuryeler, Mahalle Mutfak Koçları, iş ortakları veya diğer başvuru sahipleri platform üzerinden başvuru yapabilir.

Başvuru yapılması, başvurunun otomatik olarak kabul edildiği anlamına gelmez. Sofrasofra başvuruları inceleyebilir, ek bilgi veya belge isteyebilir, eksik ya da riskli görülen başvuruları beklemeye alabilir, reddedebilir veya daha sonra yeniden değerlendirebilir.

Başvuru sahipleri; kimlik, iletişim, çalışma durumu, fatura, vergi, IBAN, işletme, yetki, deneyim ve faaliyet bilgileri dahil olmak üzere sundukları tüm bilgilerin doğruluğundan sorumludur.

Sofrasofra, başvuruların değerlendirilmesinde platform güvenliği, operasyonel yeterlilik, kalite, hizmet standardı, mevzuata uyum, tüketici güvenliği, hijyen, finansal uygunluk ve benzeri kriterleri dikkate alabilir.

6. Üretici, Şef ve Restoran Yükümlülükleri

Platformda ürün, hizmet, eğitim, danışmanlık, imza tabağı, restoran ürünü, galeri veya benzeri içerik sunan üretici, şef ve restoranlar aşağıdaki yükümlülükleri kabul eder:

- Sundukları ürün ve hizmetlerin doğru, güncel ve yanıltıcı olmayan bilgilerle yayınlanmasını sağlamak,
- Fiyat, ürün açıklaması, teslimat seçeneği, görsel, stok, hazırlık süresi ve içerik bilgilerinin doğruluğundan sorumlu olmak,
- Gıda güvenliği, hijyen, sağlık, vergi, fatura, tüketici, mesleki faaliyet ve ilgili tüm mevzuata uygun hareket etmek,
- Üçüncü kişilerin marka, telif, fotoğraf, kişilik hakkı, ticari sır veya fikri mülkiyet haklarını ihlal etmemek,
- Sipariş, rezervasyon, danışmanlık, eğitim veya hizmet taleplerini dürüstlük kuralına uygun şekilde yerine getirmek,
- Müşteri şikâyetleri, iptal, iade, gecikme, ayıplı ürün veya hizmet sorunlarında Sofrasofra destek ve operasyon süreçleriyle iş birliği yapmak,
- Vergi, fatura, kazanç, hak ediş, komisyon ve resmi yükümlülüklerden kendi statüleri ölçüsünde sorumlu olduklarını kabul etmek.

Sofrasofra, üretici, şef veya restoranın sunduğu ürün/hizmetlerin mevzuata aykırı, yanıltıcı, riskli, şikâyete konu, eksik, uygunsuz veya platform standartlarına aykırı olduğunu değerlendirirse ilgili içeriği kaldırabilir, görünürlüğünü azaltabilir, hesabı geçici olarak durdurabilir veya başvuruyu sonlandırabilir.

7. Kurye ve Teslimat Süreçleri

Kurye olarak başvuru yapan veya teslimat süreçlerine dahil olan kişiler; kimlik, iletişim, konum, görev, teslimat ve operasyon bilgilerinin doğru olmasından sorumludur.

Kuryeler, görev aldıkları teslimat süreçlerinde müşteri, üretici, şef, restoran ve platform güvenliğini gözetmekle; siparişin zamanında, dikkatli ve dürüstlük kuralına uygun şekilde taşınması için gerekli özeni göstermekle yükümlüdür.

Teslimat sürecinde trafik kurallarına, genel güvenlik kurallarına, mesleki özen yükümlülüklerine ve ilgili mevzuata uygun hareket etmek kurye sorumluluğundadır.

Sofrasofra, kurye atama, görev takibi, teslimat durumu, konum takibi, teslimat geçmişi ve operasyon güvenliği amacıyla gerekli teknik ve idari süreçleri yürütebilir.

8. Sipariş, Sepet, Ödeme ve Teslimat

Platform üzerinden ürün veya hizmet sepete eklenebilir, sipariş oluşturulabilir, ödeme sayfasına yönlendirme yapılabilir veya teslimat/gel-al seçenekleri sunulabilir.

Sipariş içeriği, fiyat, teslimat seçeneği, ödeme durumu, komisyon, platform hizmet bedeli, ödeme işlem ücreti, kurye bedeli veya benzeri kalemler platform ekranlarında gösterilebilir.

Ödeme işlemleri, ilgili ödeme hizmet sağlayıcısının güvenli altyapısı üzerinden gerçekleştirilebilir. Sofrasofra kart numarası, CVV gibi hassas kart bilgilerini kendi sistemlerinde saklamaz.

Siparişin hazırlanması, ürünün niteliği, ürün açıklamasının doğruluğu, ürünün teslimata uygunluğu, hizmetin ifası ve müşteriyle olan ticari ilişkinin ilgili kısmı, ürün veya hizmeti sunan üretici, şef, restoran veya hizmet sağlayıcının sorumluluğundadır.
...
9. İptal, İade ve Cayma Süreçleri

Sipariş iptali, iade, geri ödeme ve cayma hakkına ilişkin süreçler; ürünün niteliğine, hazırlanma aşamasına, kişiye özel olup olmamasına, gıda ürünü olup olmamasına, teslimat durumuna, hizmetin ifa edilip edilmediğine ve ilgili mevzuata göre değerlendirilir.

Çabuk bozulabilen veya son kullanma tarihi geçebilecek gıda ürünleri, kişiye özel hazırlanan ürünler, hijyen veya sağlık açısından iadesi uygun olmayan ürünler ve ilgili mevzuatta cayma hakkı istisnası kapsamında değerlendirilebilecek ürün/hizmetler için cayma hakkı sınırlanabilir.

İptal, iade ve cayma süreçlerine ilişkin ayrıntılı hükümler ayrıca İptal, İade ve Cayma Hakkı Politikası, Ön Bilgilendirme Formu ve Mesafeli Satış Sözleşmesi içinde düzenlenir.

10. Platform İçerikleri ve Fikri Haklar
...
Kullanıcılar, platformu yalnızca işbu Kullanım Koşulları’na ve hukuka uygun şekilde kullanabilir. Platform içerikleri, Sofrasofra’nın yazılı izni olmadan kopyalanamaz, çoğaltılamaz, değiştirilemez, satılamaz, kiralanamaz, ticari amaçla kullanılamaz veya üçüncü kişilere aktarılamaz.

Kullanıcılar, platforma yükledikleri fotoğraf, video, açıklama, yorum, ürün bilgisi, eğitim, galeri veya diğer içeriklerin hukuka uygun olduğunu, gerekli izinlere sahip olduklarını ve üçüncü kişilerin haklarını ihlal etmediklerini kabul eder.

Kullanıcı, platforma içerik yüklemekle Sofrasofra’ya söz konusu içeriği platformda yayınlama, görüntüleme, tanıtma, düzenleme, teknik olarak işleme, vitrinlerde gösterme, sosyal medya veya kurumsal tanıtım alanlarında kullanma konusunda gerekli ölçüde kullanım izni verdiğini kabul eder. Bu konu ayrıca Fotoğraf, Video ve İçerik Yayın İzni metninde düzenlenebilir.

11. Yasaklı Kullanımlar

Kullanıcılar aşağıdaki davranışlarda bulunamaz:

- Platformu hukuka, ahlaka, kamu düzenine veya üçüncü kişi haklarına aykırı şekilde kullanmak,
- Yanıltıcı, sahte, eksik veya başkasına ait bilgilerle işlem yapmak,
- Başkasının hesabını izinsiz kullanmak,
- Sahte sipariş, sahte başvuru, sahte yorum veya manipülatif işlem oluşturmak,
- Platformun güvenliğini, yazılımını, veri tabanını veya teknik altyapısını bozmak,
- Virüs, zararlı kod, otomatik bot, kazıma, spam veya yetkisiz veri toplama faaliyetlerinde bulunmak,
- Üçüncü kişilerin kişisel verilerini hukuka aykırı şekilde paylaşmak,
- Marka, telif, görsel, fotoğraf, video, kişilik hakkı veya ticari sır ihlali yapmak,
- Gıda güvenliği, hijyen, tüketici, vergi, fatura veya ilgili mevzuata aykırı ürün/hizmet sunmak,
- Sofrasofra adını, logosunu veya itibarını yanıltıcı şekilde kullanmak.

Bu tür davranışların tespiti halinde Sofrasofra, ilgili içeriği kaldırabilir, hesabı askıya alabilir, siparişi veya başvuruyu iptal edebilir, ilgili mercilere bildirimde bulunabilir ve doğan zararların tazminini talep edebilir.

12. Yorumlar, Değerlendirmeler ve Kullanıcı İçeriği

Kullanıcılar platformda yorum, puanlama, değerlendirme veya benzeri içerikler paylaşabilir. Bu içerikler hukuka, dürüstlük kuralına, kişilik haklarına, ticari itibara ve genel ahlaka uygun olmalıdır.

Hakaret, tehdit, ayrımcılık, kişisel veri ifşası, yanıltıcı bilgi, reklam, spam, haksız rekabet veya üçüncü kişi haklarını ihlal eden yorum ve içerikler kaldırılabilir.

Sofrasofra, yorumları ve kullanıcı içeriklerini önceden veya sonradan inceleyebilir; ancak tüm içerikleri sürekli denetleme yükümlülüğü altında değildir.

13. Hizmetin Kesintiye Uğraması ve Teknik Değişiklikler

Sofrasofra, platformun kesintisiz, hatasız veya her zaman erişilebilir olacağını garanti etmez. Bakım, güncelleme, teknik arıza, altyapı hizmet sağlayıcılarından kaynaklanan sorunlar, internet kesintileri, ödeme sağlayıcı arızaları, siber saldırılar, mücbir sebepler veya benzeri nedenlerle hizmetlerde geçici kesintiler yaşanabilir.

Sofrasofra, platformun tasarımını, özelliklerini, teknik altyapısını, sayfa yapısını, üyelik modellerini, ücretlendirme, komisyon, görünürlük, vitrin ve operasyon sistemlerini önceden bildirim yaparak veya gerekli hallerde derhal değiştirebilir.

14. Ücretler, Komisyonlar ve Platform Hizmet Bedelleri

Sofrasofra, üretici, şef, restoran, kurye, müşteri veya iş ortaklarına yönelik ücretsiz veya ücretli hizmet modelleri sunabilir. Bu kapsamda komisyon, üyelik bedeli, platform hizmet bedeli, ödeme işlem ücreti, reklam, vitrin, öne çıkarma, teslimat, operasyon, danışmanlık veya benzeri ücretler uygulanabilir.

Geçerli ücretler, komisyon oranları ve ödeme koşulları platform ekranlarında, başvuru süreçlerinde, sözleşmelerde veya ilgili bilgilendirme alanlarında gösterilebilir.

Sofrasofra, ücret ve komisyon modellerinde değişiklik yapma hakkını saklı tutar. Değişiklikler yürürlük tarihinden itibaren geçerli olur.

15. Sorumluluk Sınırları
...
Sofrasofra, platform üzerinde yer alan üretici, şef, restoran, kurye veya kullanıcı içeriklerinin her zaman doğru, eksiksiz, güncel veya mevzuata uygun olduğunu garanti etmez. Ancak bildirilen veya tespit edilen uygunsuzluklar için makul inceleme ve müdahale süreçleri yürütülebilir.

Ödeme hizmet sağlayıcıları, harita servisleri, video platformları, sosyal medya platformları, bulut altyapısı, internet servisleri veya üçüncü taraf bağlantılarından kaynaklanan aksaklıklar ilgili hizmet sağlayıcıların sorumluluğunda olabilir.
...
17. Hesap Askıya Alma ve Hizmetin Sonlandırılması

Sofrasofra; hukuka aykırılık, güvenlik riski, yanıltıcı bilgi, sahte işlem, kullanıcı şikâyeti, ödeme sorunu, uygunsuz içerik, hijyen veya kalite riski, platform itibarını zedeleyen davranış, mevzuata aykırılık veya işbu Kullanım Koşulları’na aykırılık halinde ilgili hesabı, başvuruyu, ürünü, profili, içeriği veya hizmeti geçici ya da kalıcı olarak durdurabilir.

Kullanıcı, hesabını kapatmak veya üyeliğini sonlandırmak istediğinde Sofrasofra ile iletişime geçebilir. Mevzuat gereği saklanması gereken kayıtlar, yasal süreler boyunca saklanmaya devam edebilir.

18. Kişisel Veriler

Kişisel verilerin işlenmesine ilişkin esaslar Gizlilik Politikası, KVKK Aydınlatma Metni, Çerez Politikası, Açık Rıza Metni ve ilgili diğer hukuki metinlerde düzenlenir.
...
19. Üçüncü Taraf Bağlantılar

Platformda ödeme sayfaları, harita servisleri, video platformları, sosyal medya hesapları, destek kanalları veya üçüncü taraf internet sitelerine bağlantılar bulunabilir.

Üçüncü taraf hizmetlerin kullanım koşulları ve gizlilik politikaları ilgili hizmet sağlayıcıya aittir. Sofrasofra, üçüncü taraf hizmetlerin içeriklerinden, güvenliğinden, veri işleme uygulamalarından veya kesintilerinden sorumlu değildir.

20. Kullanım Koşullarında Değişiklik

Sofrasofra, işbu Kullanım Koşulları’nı mevzuat değişiklikleri, hizmet modeli, teknik altyapı, operasyonel ihtiyaçlar, güvenlik gereklilikleri veya platform politikaları doğrultusunda güncelleyebilir.

Güncel Kullanım Koşulları www.sofrasofra.com ve ilgili dijital kanallar üzerinden yayınlandığı anda yürürlüğe girer. Platformun kullanılmaya devam edilmesi, güncel koşulların kabul edildiği anlamına gelir.

21. Uygulanacak Hukuk ve Uyuşmazlık Çözümü

İşbu Kullanım Koşulları’nın uygulanmasında Türkiye Cumhuriyeti hukuku geçerlidir.

Tüketici sıfatına sahip kullanıcıların mevzuattan kaynaklanan hakları saklıdır. Tüketici işlemlerinde ilgili mevzuat uyarınca tüketici hakem heyetleri ve tüketici mahkemeleri yetkili olabilir.
...
Kullanım Koşulları’na ilişkin soru, talep ve bildirimler için aşağıdaki iletişim kanalları kullanılabilir:
...
''',
  ...
  SofrasofraHukukiMetin(
    ...
    summary: 'Sofrasofra üyeliğine ilişkin hak ve yükümlülükler.',
    content: '''
Üyelik Sözleşmesi
...
İşbu Mesafeli Satış Sözleşmesi, Sofrasofra platformu üzerinden elektronik ortamda verilen siparişlerde, alıcı ile satıcı/hizmet sağlayıcı arasında kurulan mesafeli satış ilişkisine ilişkin hak ve yükümlülükleri düzenlemek amacıyla hazırlanmıştır.
...
Sofrasofra platformunda Ev Lezzetleri üreticisi, Usta Şef, restoran, işletme veya benzeri sıfatla ürün ya da hizmet sunan kişidir. Satıcı/hizmet sağlayıcıya ait bilgiler, ilgili ürün, profil, başvuru, sipariş veya fatura kayıtlarında gösterilebilir.

2. Sözleşmenin Konusu

İşbu Sözleşme’nin konusu; alıcının Sofrasofra platformu üzerinden elektronik ortamda sipariş verdiği ürün veya hizmetlerin satışı, hazırlanması, teslimi, ödemesi, iptali, iadesi, cayma hakkı ve tarafların hak ve yükümlülüklerinin belirlenmesidir.

Sofrasofra; Ev Lezzetleri üreticilerini, Usta Şefleri, restoranları, kuryeleri ve müşterileri dijital ortamda bir araya getiren teknoloji tabanlı bir platformdur.

Sofrasofra’nın rolü, her somut işlemde ürünün doğrudan satıcısı olduğu anlamına gelmez. Ürün veya hizmeti fiilen sunan satıcı/hizmet sağlayıcı; ürünün niteliği, içeriği, hijyeni, açıklaması, fiyatı, hazırlanması, faturalandırılması ve mevzuata uygunluğundan kendi statüsü ve faaliyeti ölçüsünde sorumludur.

3. Ürün ve Hizmet Bilgileri

Siparişe konu ürün veya hizmetin temel nitelikleri, satış fiyatı, varsa teslimat/kurye bedeli, ödeme işlem ücreti, platform hizmet bedeli, teslimat yöntemi, hazırlık süresi, satıcı/hizmet sağlayıcı bilgisi ve diğer sipariş detayları sipariş öncesinde platform ekranlarında gösterilir.

Alıcı, sipariş vermeden önce ürün/hizmet açıklamasını, fiyatı, teslimat/gel-al seçeneklerini, varsa alerjen veya içerik açıklamalarını, iptal/iade koşullarını ve sipariş özetini kontrol etmekle yükümlüdür.

Gıda ürünleri, ev yapımı yemekler, kişiye özel hazırlanabilen siparişler, belirli tarih ve saat için hazırlanan ürünler, danışmanlık, eğitim, rezervasyon, davet, catering veya benzeri hizmetler ürünün/hizmetin niteliğine göre farklı iptal, iade ve cayma koşullarına tabi olabilir.

4. Siparişin Oluşturulması

Alıcı, platform üzerinden ürünü veya hizmeti seçip sepete ekleyerek, sipariş bilgilerini onaylayarak ve ödeme adımını tamamlayarak sipariş oluşturabilir.

Siparişin alınması, ödeme sürecinin başarıyla tamamlanması, satıcı/hizmet sağlayıcının siparişi kabul etmesi veya platform tarafından operasyonel olarak onaylanması gibi aşamalar sipariş türüne göre değişebilir.

Sofrasofra, teknik hata, stok/talep uygunsuzluğu, ödeme başarısızlığı, satıcı/hizmet sağlayıcı onayının alınamaması, teslimat imkânsızlığı, güvenlik riski veya mevzuata aykırılık halinde siparişi iptal edebilir ya da işleme almayabilir.
...
Sipariş bedeli; ürün/hizmet bedeli, varsa teslimat/kurye bedeli, ödeme işlem ücreti, platform hizmet bedeli, komisyon veya ilgili ek kalemlerden oluşabilir. Bu kalemler platform ekranlarında gösterilebilir.

Ödeme başarısız olursa sipariş tamamlanmayabilir. Ödemenin alınmasına rağmen siparişin ifa edilememesi halinde iptal/iade süreci ilgili mevzuat, satıcı/hizmet sağlayıcı durumu ve ödeme hizmet sağlayıcısı kuralları dikkate alınarak yürütülür.

6. Teslimat ve Gel-Al

Teslimat; satıcı/hizmet sağlayıcı, platform kuryesi, bağımsız kurye, üçüncü taraf teslimat hizmeti veya alıcının gel-al tercihiyle gerçekleştirilebilir.

Teslimat adresinin doğru, açık ve ulaşılabilir şekilde girilmesinden alıcı sorumludur. Yanlış, eksik veya ulaşılamayan adres, telefonun kapalı olması, alıcının teslimat noktasında bulunmaması veya teslimatın alıcıdan kaynaklanan sebeplerle gerçekleştirilememesi halinde doğabilecek gecikme, iptal veya ek maliyetlerden alıcı sorumlu olabilir.
...
7. Satıcı / Hizmet Sağlayıcının Yükümlülükleri

Satıcı/hizmet sağlayıcı aşağıdaki yükümlülükleri kabul eder:

- Ürün veya hizmet bilgilerini doğru, güncel ve yanıltıcı olmayacak şekilde sunmak,
- Fiyat, açıklama, görsel, içerik, hazırlık süresi, teslimat seçeneği ve stok bilgilerini doğru yönetmek,
- Gıda güvenliği, hijyen, sağlık, vergi, fatura, tüketici ve ilgili mevzuata uygun hareket etmek,
- Siparişi dürüstlük kuralına, ürün açıklamasına ve platformda belirtilen koşullara uygun şekilde hazırlamak veya sunmak,
- İptal, iade, gecikme, eksik ürün, ayıplı ürün veya müşteri şikâyeti halinde Sofrasofra destek ve operasyon süreçleriyle iş birliği yapmak,
- Kendi vergi, fatura, gelir, izin, ruhsat, üretim ve mesleki yükümlülüklerinden sorumlu olduğunu kabul etmek.

8. Alıcının Yükümlülükleri

Alıcı aşağıdaki yükümlülükleri kabul eder:

- Sipariş öncesinde ürün/hizmet bilgilerini, fiyatı, teslimat seçeneğini, cayma/iptal/iade koşullarını ve sipariş özetini kontrol etmek,
- Teslimat adresi, telefon, fatura ve iletişim bilgilerini doğru ve güncel vermek,
- Gıda alerjisi, hassasiyet, özel beslenme tercihi veya benzeri konularda satıcı/hizmet sağlayıcı açıklamalarını dikkatle incelemek ve gerekirse sipariş öncesi destek istemek,
- Teslimat veya gel-al sürecinde belirtilen saat ve adreste hazır bulunmak,
- Platformu, ödeme sistemini, sipariş sürecini veya destek kanallarını kötüye kullanmamak,
- Sipariş ve ödeme işlemlerinde hukuka ve dürüstlük kuralına uygun hareket etmek.

9. Sofrasofra’nın Platform Rolü

Sofrasofra; siparişin dijital ortamda oluşturulması, ödeme yönlendirmesi, satıcı/hizmet sağlayıcı görünürlüğü, teslimat organizasyonu, sepet, sipariş takibi, destek, uyuşmazlık ve operasyon süreçlerinde teknik altyapı ve platform hizmeti sunar.

Sofrasofra, satıcı/hizmet sağlayıcı tarafından sunulan ürün veya hizmetin fiili üreticisi, hazırlayıcısı veya sağlayıcısı olmayabilir. Bu nedenle ürünün içeriği, hijyeni, ayıplı olup olmadığı, mevzuata uygunluğu, faturalandırma ve fiili ifa süreçlerinden esasen ilgili satıcı/hizmet sağlayıcı sorumludur.

Sofrasofra, kullanıcı güvenliği, platform düzeni, tüketici memnuniyeti ve operasyon kalitesi için makul inceleme, yönlendirme, destek, içerik kaldırma, satıcı/hizmet sağlayıcı uyarma, görünürlük azaltma, hesap askıya alma veya başvuru sonlandırma gibi önlemler alabilir.
...
Alıcı, siparişin durumuna göre iptal talebinde bulunabilir. İptal talebi; siparişin hazırlanma aşaması, ürünün niteliği, satıcı/hizmet sağlayıcı onayı, kurye ataması, ödeme durumu ve teslimat aşaması dikkate alınarak değerlendirilir.
...
Satıcı/hizmet sağlayıcıdan kaynaklanan hazırlanamama, stok/üretim imkânsızlığı, kalite sorunu veya teslimat imkânsızlığı hallerinde sipariş iptal edilebilir ve uygun görülen hallerde bedel iadesi yapılabilir.

13. İade ve Geri Ödeme

İade ve geri ödeme süreci; ürün/hizmetin niteliği, cayma hakkı durumu, iptal sebebi, ödeme yöntemi, satıcı/hizmet sağlayıcı sorumluluğu ve ödeme hizmet sağlayıcısının işlem kuralları dikkate alınarak yürütülür.

İade yapılması gereken hallerde geri ödeme, mümkün olduğu ölçüde alıcının ödeme yaptığı yöntemle gerçekleştirilir. Banka, kart kuruluşu veya ödeme hizmet sağlayıcısından kaynaklanan gecikmeler Sofrasofra’nın doğrudan kontrolü dışında olabilir.

Kısmi iade, tam iade, kupon, bakiye, yeniden gönderim, ürün değişimi veya destek çözümü gibi yöntemler somut olayın niteliğine göre uygulanabilir.

Teslim edilmiş ve niteliği gereği iadesi mümkün olmayan gıda ürünlerinde iade yerine kalite incelemesi, destek kaydı, satıcı değerlendirmesi veya uygun görülen başka bir çözüm uygulanabilir.

14. Ayıplı, Eksik veya Hatalı Ürün/Hizmet

Alıcı, siparişin eksik, hatalı, bozuk, ayıplı, açıklamaya aykırı veya teslimata uygun olmayan şekilde geldiğini düşünüyorsa durumu makul süre içinde Sofrasofra destek kanallarına bildirmelidir.

Bildirimde sipariş numarası, ürün/hizmet bilgisi, açıklama, fotoğraf, video veya destekleyici bilgi talep edilebilir.

Sofrasofra, satıcı/hizmet sağlayıcı, kurye ve alıcı beyanlarını, fotoğraf/video kayıtlarını, sipariş geçmişini, teslimat durumunu ve ilgili operasyon kayıtlarını inceleyerek makul bir çözüm süreci yürütebilir.

Ayıplı veya eksik ifadan doğan yasal sorumluluk, somut olayın niteliğine göre ilgili satıcı/hizmet sağlayıcıya ait olabilir.

15. Fatura ve Vergisel Yükümlülükler
...
16. Gıda Güvenliği, Alerjenler ve Ürün İçeriği

Gıda ürünlerinde içerik, alerjen, üretim yöntemi, saklama koşulları, porsiyon, gramaj, sıcaklık, tazelik ve benzeri bilgiler satıcı/hizmet sağlayıcı tarafından sağlanır.

Alıcı; alerji, intolerans, sağlık hassasiyeti, özel diyet, hamilelik, çocuk tüketimi veya benzeri özel durumlarda sipariş öncesinde ürün açıklamalarını dikkatle incelemeli ve gerekirse satıcı/hizmet sağlayıcı veya Sofrasofra destek kanalları üzerinden bilgi almalıdır.

Sofrasofra, satıcı/hizmet sağlayıcı tarafından bildirilmeyen veya eksik bildirilen içerik, alerjen, hijyen, üretim veya saklama bilgilerinden doğrudan sorumlu tutulamayabilir. Ancak bildirilen risklerde makul inceleme ve destek süreci yürütebilir.

17. Uyuşmazlık ve Destek Süreci

Alıcı, satıcı/hizmet sağlayıcı, kurye veya teslimat süreciyle ilgili soru, talep ve şikâyetlerini Sofrasofra destek kanallarına iletebilir.
...
Doğal afet, yangın, sel, deprem, salgın hastalık, savaş, terör, grev, lokavt, resmi makam kararları, internet ve enerji kesintileri, ödeme sistemi arızaları, bulut altyapısı sorunları, siber saldırılar, trafik, hava koşulları, tedarik ve teslimat aksaklıkları veya tarafların makul kontrolü dışında gelişen olaylar mücbir sebep sayılır.

Mücbir sebep hallerinde siparişin hazırlanması, teslimi, iptali, iadesi veya hizmetin ifası gecikebilir, askıya alınabilir veya imkânsız hale gelebilir.

20. Uygulanacak Hukuk ve Yetki

İşbu Mesafeli Satış Sözleşmesi’nin uygulanmasında Türkiye Cumhuriyeti hukuku geçerlidir.
...
Ticari nitelikteki işlemler veya iş ortaklığı ilişkilerinden kaynaklanan uyuşmazlıklarda, mevzuatın emredici hükümleri saklı kalmak kaydıyla İstanbul mahkemeleri ve icra daireleri yetkili kabul edilebilir.

21. Yürürlük

Alıcı, platform üzerinden sipariş vererek işbu Mesafeli Satış Sözleşmesi’ni, Ön Bilgilendirme Formu’nu, İptal, İade ve Cayma Hakkı Politikası’nı ve ilgili diğer hukuki metinleri okuduğunu, anladığını ve siparişe uygulanacak koşulları kabul ettiğini beyan eder.

İşbu Sözleşme, elektronik ortamda alıcı tarafından onaylandığı veya sipariş oluşturulduğu anda yürürlüğe girer.

22. İletişim

Mesafeli Satış Sözleşmesi’ne ilişkin soru, talep ve bildirimler için aşağıdaki iletişim kanalları kullanılabilir:
...
İşbu Başvuru ve İş Ortaklığı Aydınlatma Metni, Sofrasofra platformuna Ev Lezzetleri üreticisi, Usta Şef, restoran, kurye, Mahalle Mutfak Koçu, iş ortağı, tedarikçi, danışman, operasyon destekçisi veya benzeri sıfatlarla başvuru yapan kişilerin kişisel verilerinin işlenmesine ilişkin bilgilendirme yapmak amacıyla hazırlanmıştır.

Bu metin; Sofrasofra web sitesi, mobil uygulamaları, web uygulaması, başvuru formları, destek kanalları, e-posta, WhatsApp, telefon, Google Sheets, n8n, Firebase/Google altyapıları ve bağlantılı dijital başvuru/değerlendirme süreçleri için geçerlidir.
...
Bu Aydınlatma Metni aşağıdaki kişileri kapsayabilir:

- Ev Lezzetleri üreticisi olarak başvuru yapan kişiler,
- Usta Şef olarak başvuru yapan kişiler,
- Restoran, kafe, işletme veya profesyonel hizmet sağlayıcı olarak başvuru yapan kişiler,
- Kurye olarak başvuru yapan kişiler,
- Mahalle Mutfak Koçu veya saha destek görevlisi olarak başvuru yapan kişiler,
- İş ortağı, tedarikçi, danışman, hizmet sağlayıcı veya operasyon destekçisi olarak başvuru yapan kişiler,
- Sofrasofra ile ticari, operasyonel veya kurumsal iş birliği kurmak isteyen gerçek kişiler veya tüzel kişi temsilcileri.

4. İşlenebilecek Kişisel Veri Kategorileri

Başvuru ve iş ortaklığı süreçlerinde aşağıdaki kişisel veri kategorileri işlenebilir:

Kimlik bilgileri:
Ad, soyad, T.C. kimlik numarası, vergi kimlik numarası, unvan, temsilci bilgisi ve başvuru sahibini tanımlamaya yarayan bilgiler.

İletişim bilgileri:
Telefon numarası, e-posta adresi, şehir, ilçe, adres, WhatsApp bilgisi ve iletişim tercihleri.

Başvuru bilgileri:
Başvuru türü, başvuru tarihi, başvuru statüsü, faaliyet alanı, çalışma modeli, deneyim, açıklama, notlar, mutfak/işletme adı, ürün/hizmet türü, kategori, başvuru formu cevapları ve değerlendirme kayıtları.

Mesleki ve faaliyet bilgileri:
Şeflik, aşçılık, pastacılık, restoran işletmeciliği, ev üretimi, kurye deneyimi, danışmanlık, eğitim, catering, işletme deneyimi, araç/ulaşım bilgileri, çalışma uygunluğu ve faaliyet bilgileri.

Fatura ve finansal bilgiler:
T.C. kimlik numarası veya vergi numarası, vergi dairesi, fatura adresi, fatura e-posta adresi, IBAN, hak ediş, komisyon, ödeme, mahsuplaşma ve fatura süreçlerine ilişkin bilgiler.

İçerik ve görsel bilgiler:
Başvuru kapsamında paylaşılan ürün fotoğrafları, profil/kapak görselleri, galeri fotoğrafları, videolar, YouTube bağlantıları, menü, ürün açıklamaları, eğitim/danışmanlık içerikleri ve tanıtım materyalleri.

Teknik ve işlem güvenliği bilgileri:
IP adresi, cihaz bilgisi, tarayıcı bilgisi, oturum kayıtları, başvuru işlem zamanı, log kayıtları, güvenlik kayıtları ve sistem kullanım verileri.

Destek ve iletişim kayıtları:
E-posta, WhatsApp, telefon, destek formu veya diğer iletişim kanalları üzerinden iletilen mesajlar, talepler, başvuru notları, operasyon değerlendirmeleri ve iç inceleme kayıtları.

5. Özel Nitelikli Kişisel Veriler

Sofrasofra, başvuru ve iş ortaklığı süreçlerinde kural olarak özel nitelikli kişisel veri talep etmez.

Başvuru sahiplerinin sağlık bilgisi, biyometrik veri, dini inanç, siyasi görüş, dernek/vakıf/sendika üyeliği, ceza mahkûmiyeti veya güvenlik tedbiri bilgisi gibi özel nitelikli kişisel verileri başvuru formlarına, açıklama alanlarına, e-posta veya destek kanallarına eklememesi esastır.

Buna rağmen başvuru sahibi tarafından özel nitelikli kişisel veri içeren bilgi veya belge paylaşılması halinde, bu bilgiler yalnızca ilgili talebin değerlendirilmesi, hukuki yükümlülüklerin yerine getirilmesi veya mevzuatta öngörülen sınırlı haller kapsamında işlenebilir. Gerekli olmayan özel nitelikli veriler sistemlerden silinebilir veya dikkate alınmayabilir.

6. Kişisel Verilerin İşlenme Amaçları

Başvuru ve iş ortaklığı kapsamında kişisel veriler aşağıdaki amaçlarla işlenebilir:

- Başvurunun alınması, kaydedilmesi ve başvuru sahibinin tanımlanması,
- Ev Lezzetleri, Usta Şef, restoran, kurye, Mahalle Mutfak Koçu veya iş ortaklığı başvurularının değerlendirilmesi,
- Başvuru sahibinin faaliyet alanı, uygunluğu, deneyimi, çalışma modeli ve platforma uyumunun incelenmesi,
- Başvuru sonucunun bildirilmesi,
- Eksik bilgi veya belge talep edilmesi,
- İç denetim, risk değerlendirmesi, kalite kontrol ve operasyonel uygunluk incelemelerinin yapılması,
- Platform güvenliği, müşteri güvenliği, gıda güvenliği ve hizmet kalitesi süreçlerinin yürütülmesi,
- Üretici, şef, restoran veya kurye profili oluşturulması,
- Fatura, hak ediş, komisyon, ödeme, IBAN ve mali süreçlerin hazırlanması,
- Sözleşme süreçlerinin kurulması, ifası ve sona erdirilmesi,
- Destek, talep, şikâyet ve iletişim süreçlerinin yürütülmesi,
- Yasal yükümlülüklerin yerine getirilmesi,
- Yetkili kamu kurum ve kuruluşlarından gelen taleplerin karşılanması,
- Uyuşmazlık, talep, denetim, savunma ve hukuki süreçlerin yürütülmesi,
- Sofrasofra’nın iş geliştirme, operasyon planlama ve platform büyüme süreçlerinin desteklenmesi.
...
Bir sözleşmenin kurulması veya ifasıyla doğrudan doğruya ilgili olması:
Başvuru, iş ortaklığı, platforma kabul, hizmet sağlayıcı ilişkisi, kurye görevlendirme, üretici/şef/restoran profili ve ilgili sözleşme süreçlerinin yürütülmesi.

Veri sorumlusunun hukuki yükümlülüğünü yerine getirmesi:
Fatura, vergi, muhasebe, ticaret, resmi kurum talepleri, başvuru kayıtları ve mevzuata uyum süreçleri.

Bir hakkın tesisi, kullanılması veya korunması:
Başvuru uyuşmazlıkları, şikâyetler, itirazlar, hukuki talepler, savunma ve denetim süreçleri.

İlgili kişinin temel hak ve özgürlüklerine zarar vermemek kaydıyla meşru menfaat:
Başvuru değerlendirme, operasyonel uygunluk, platform güvenliği, kalite kontrol, iç denetim, risk analizi ve kötüye kullanımın önlenmesi.

Açık rıza:
Açık rıza gerektiren tanıtım, pazarlama, ticari ileti, belirli çerez kullanımları, yurt dışı aktarım veya mevzuat gereği açık rıza gerektiren diğer faaliyetler.

Kanunlarda açıkça öngörülmesi:
Vergi, ticaret, tüketici, elektronik ticaret, iş ortaklığı ve ilgili diğer mevzuat kapsamında tutulması gereken kayıtlar.

8. Kişisel Verilerin Toplanma Yöntemleri

Kişisel veriler; Sofrasofra web sitesi, mobil uygulamalar, web uygulaması, başvuru formları, üyelik ekranları, üretici/şef/restoran/kurye başvuru sayfaları, destek e-postaları, WhatsApp, telefon, Google Sheets, n8n destek/analiz akışları, Firebase/Google altyapıları, yüklenen fotoğraf/video/içerikler, çerezler, log kayıtları ve platform içi işlem kayıtları aracılığıyla elektronik ortamda toplanabilir.

Kişisel veriler, başvuru sahibi tarafından doğrudan sağlanabileceği gibi, platform kullanımı ve başvuru değerlendirme süreçleri sırasında otomatik veya kısmen otomatik yollarla da oluşabilir.

9. Kişisel Verilerin Aktarılması

Kişisel veriler, başvuru ve iş ortaklığı süreçlerinin gerektirdiği ölçüde aşağıdaki kişi, kurum ve taraflarla paylaşılabilir:

- Bulut altyapısı, veri tabanı, barındırma, güvenlik, bildirim, analiz ve teknik hizmet sağlayıcıları,
- E-posta, WhatsApp, telefon, destek, CRM, otomasyon ve operasyon araçları,
- Muhasebe, e-fatura, e-arşiv, finans ve mali müşavirlik hizmet sağlayıcıları,
- Ödeme ve hak ediş süreçleriyle ilgili ödeme hizmet sağlayıcıları veya bankalar,
- Hukuk danışmanları, denetçiler ve yetkili temsilciler,
- Yetkili kamu kurum ve kuruluşları,
- Kanunen yetkili özel hukuk kişileri,
- Başvurunun niteliğine göre Sofrasofra operasyon, destek, denetim ve yönetim ekipleri.

Sofrasofra, kişisel verileri ticari amaçla üçüncü kişilere satmaz.

10. Yurt Dışına Aktarım

Sofrasofra hizmetlerinin yürütülmesinde bulut altyapısı, veri tabanı, e-posta, bildirim, analiz, güvenlik, destek, otomasyon ve teknik hizmet sağlayıcıları kullanılabilir.

Bu hizmet sağlayıcıların teknik altyapıları yurt dışında bulunabilir veya yurt dışı bağlantılı hizmet sunabilir.

Kişisel verilerin yurt dışına aktarılması gereken hallerde, KVKK’nın yurt dışına aktarım hükümleri, Kurul kararları ve yürürlükteki mevzuat hükümleri dikkate alınır. Gerekli hallerde açık rıza alınması, uygun güvencelerin sağlanması veya mevzuatta öngörülen diğer aktarım şartlarının yerine getirilmesi yoluna gidilir.

11. Başvuruların İç Denetim ve Yapay Zekâ Destekli İncelenmesi

Sofrasofra, başvuru ve iş ortaklığı süreçlerinde operasyonel verimlilik, risk tespiti, eksik bilgi kontrolü, kategori belirleme, başvuru önceliklendirme ve iç denetim amacıyla otomasyon veya yapay zekâ destekli analiz araçlarından yararlanabilir.

Bu araçlar; başvuru metinleri, başvuru türü, iletişim bilgileri, faaliyet alanı, belge/fotoğraf durumu, eksik alanlar, risk göstergeleri, kategori ve operasyon notları üzerinde ön analiz yapabilir.

Yapay zekâ veya otomasyon destekli analizler, tek başına nihai karar anlamına gelmez. Başvurular gerekli görülen hallerde Sofrasofra yetkilileri tarafından ayrıca incelenir ve nihai karar Sofrasofra tarafından verilir.

12. Saklama Süreleri

Başvuru ve iş ortaklığı verileri, başvurunun değerlendirilmesi, sonuçlandırılması, olası iş ilişkisi kurulması, sözleşme, fatura, ödeme, hak ediş, denetim, itiraz, şikâyet ve hukuki süreçlerin yürütülmesi için gerekli süre boyunca saklanır.

Saklama süreleri belirlenirken vergi, muhasebe, ticaret, borçlar hukuku, tüketici, elektronik ticaret, ödeme, fatura, sözleşme, uyuşmazlık ve zamanaşımı süreleri dikkate alınır.

Başvuru olumsuz sonuçlansa dahi, başvuru kayıtları güvenlik, denetim, tekrar başvuru değerlendirme, itiraz, uyuşmazlık veya mevzuata uyum amacıyla makul süre boyunca saklanabilir.

Saklama süresinin sona ermesi veya işleme amacının ortadan kalkması halinde kişisel veriler mevzuata uygun şekilde silinir, yok edilir veya anonim hale getirilir.

13. Başvuru Sahibinin Yükümlülükleri

Başvuru sahibi, sunduğu bilgilerin doğru, güncel, eksiksiz ve hukuka uygun olduğunu kabul eder.

Başvuru sahibi; başkasına ait kimlik, iletişim, IBAN, fatura, görsel, video, belge veya içerikleri izinsiz şekilde kullanamaz.

Yanlış, eksik, yanıltıcı veya hukuka aykırı bilgi verilmesi halinde başvuru reddedilebilir, onaylanmış başvuru iptal edilebilir, hesap askıya alınabilir veya yasal süreç başlatılabilir.
...
KVKK kapsamındaki başvurular, başvuru süreçlerine ilişkin talepler ve kişisel verilerin korunmasına yönelik bildirimler info@sofrasofra.com adresine iletilebilir.

Başvuruda ad, soyad, iletişim bilgisi, talep konusu ve başvurucunun kimliğini doğrulamaya yarayacak bilgiler yer almalıdır.
...
Sofrasofra, işbu Başvuru ve İş Ortaklığı Aydınlatma Metni’ni mevzuat değişiklikleri, hizmet modeli, teknik altyapı, operasyonel ihtiyaçlar, başvuru süreçleri veya platform politikaları doğrultusunda güncelleyebilir.
